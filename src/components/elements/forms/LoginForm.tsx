...
const LoginForm: FC = () => {
  ...
  return (
    <Fragment>
      <h2 className="mb-3 text-start">Üdv újra!</h2>
      ...
      <p className="mb-1">
        <NextLink title="Elfelejtetted a jelszavad?" href="/register" className="hover" />
      </p>

      <p className="mb-0">
        Nincs még fiókod? <NextLink title="Regisztráció" href="/register" className="hover" />
      </p>
