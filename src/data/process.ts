...
export const processList = [
  {
    no: '1',
    className: 'me-lg-6',
    title: 'Termékválasztás',
    subtitle: 'Válassza ki a kívánt termékeket.'
  },
  {
    no: '2',
    title: 'Kosár ellenőrzése és Pénztár',
    className: 'ms-lg-13 mt-6',
    subtitle: 'Ellenőrizze a kosár tartalmát, majd folytassa a fizetési folyamatot.'
  },
  {
    no: '3',
    title: 'Visszaigazolás és Szállítás',
    className: 'mx-lg-6 mt-6',
    subtitle: 'Erősítse meg a rendelést, majd várja a gyors szállítást.'
  }
];
