...
const page = [
  ...
  {id:1, title: 'Termékek', url: '/shop-3'},
  {
    ...
    children: [
      { id: 21, url: '/contact', title: 'Kapcsolat' },
      { id: 22, url: '/aboutus', title: 'Rólunk' },
      { id: 23, url: '/info', title: 'Információk' }
    ]
  },
  {
    id: 3,
    ...
    title: 'Fiók',
    children: [
      { id: 31, url: '/register', title: 'Regisztráció' },
      { id: 32, url: '/login', title: 'Bejelentkezés' },
    ]
  },
]
export { page};
